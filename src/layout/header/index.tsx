          ...
          <StyledLogoContainer>
            <Link to='/'>
              ...
              <strong className='mobile_logo'>
                <img
                  src={`${process.env.REACT_APP_CDN_IMAGES_PATH}/mobile_logo.svg`}
                  alt=''
                />
              </strong>
            </Link>
            ...
            <StyledWelcomeContainer>
              <StyledFlexContainer1>
                <StyledMarqueeContainer>
                  <Marquee>
                    Welcome to FairPlay.&nbsp;
                    <span className='flex'>u-247</span>
                    <span className='flex'>
                      &nbsp;please enjoy an extraordinary gaming experience
                    </span>
                  </Marquee>
                  <WelcomeSvg />
                </StyledMarqueeContainer>
                <StyledParagraph>
                  <span className='js-clock'>
                    {' '}
                    29/06/2023 10:50:43 (UTC+5.5){' '}
                  </span>
                  <ClockSvg />
                </StyledParagraph>
              </StyledFlexContainer1>
